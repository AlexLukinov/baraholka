...
<div class="page_begin">
    ...
    <div class="home">
        <div class="caption">
            ...
            <!--<p class="caption_p">Проект «Барахолка» - это уникальный проект, объединивший танцоров всех стилей и направлений, а также ценителей-->
                <!--и любителей этого вида искусства. Это культурная площадка для уличных танцоров и любителей классического и народного танца.-->
            <!--</p>-->
        </div>
        <div class="meropriyatiya">
            <!--<div class="pulse-circle">-->
                ...
                <!--<div class="circle"></div>-->
            <!--</div>-->
            <!--<h2>В рамках проекта пройдут следующие мероприятия:</h2>-->
